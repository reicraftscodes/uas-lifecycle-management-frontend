        ...
        <div className="main">
            ...
            <Paper elevation={3} sx={{width: "65%", margin: "auto", p: "3%", pt: "0%", mt: "1%"}}>
                ...
                <FormControl>
                    ...
                    <TextField error={errorTailNumber} label="Aircraft tailnumber"
                               onChange={(e) => setTailNumber(e.target.value)}></TextField>
                    <br/>
                    <Divider/>
                    <br/>
                    {/*Input for the aircraft location */}
                    <Autocomplete options={locations} onChange={(event, newValue) => {
                        setLocation(newValue);
                    }} renderInput={(params) => <TextField error={errorLocation} {...params} label="Location"/>}/>
                    <br/>
                    <Divider/>
                    <Divider/>
                    <br/>
                    ...
                    <RadioGroup value={platformType} sx={{m: "auto", p: "2%"}} row
                    ...
                    <Button style={{backgroundColor: "#004789"}} variant="contained"
